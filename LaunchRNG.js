const {Blockchain, Transaction} = require('./LocalMiner');//calls the Blockchain and Transaction classes from Blockchain.js
...
const readline = require('readline').createInterface({//initializes an user interface in the kernel
